		...
		<ul class="nav navbar-top-links navbar-right">
			...
			<li>
				<a href="#" data-toggle="dropdown" class="dropdown-toggle count-info" aria-expanded="true"
						>
					<i class="fa fa-bell"></i>  <span class="notif-alert label label-danger">0</span>
				</a>
			...
			<li class="user dropdown"><a class="dropdown-toggle" href="javascript:void(0)"  data-toggle="dropdown"><i class="fa fa-user"></i> <span>{{ Lang::get('core.m_myaccount') }}</span><i class="caret"></i></a>
				<ul class="dropdown-menu dropdown-menu-right icons-right">
					...
					<li><a href="{{ URL::to('mailbox')}}"><i class="fa fa-envelope"></i> Mail </a></li>
					<li><a href="{{ URL::to('calendar')}}"><i class="fa fa-calendar"></i> Calendar </a></li>
					@if(\Auth::user()->group_id!=5)
					<li><a href="{{ URL::to('/cards') }}"><i class="fa fa-credit-card"></i> Manage Cards </a></li>
					@endif
