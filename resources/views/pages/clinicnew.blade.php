...
<div class="container">
    <div class="row">
        <h2>
            {!! SiteHelpers::showUploadedFile(SiteHelpers::gridDisplayView($id,'ClinicID','1:tb_clinic:ClinicID:Photo'),'/uploads/clinics/','auto','square',100) !!}
            {!! $pageTitle !!}
        </h2>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        @foreach($gallery as $photo)
                            {!! \SiteHelpers::showUploadedFile($photo,'/uploads/clinics/gallery/','auto','square',150) !!}
                        @endforeach
                    </div>
                </div>
                <hr/>
                                    ...
                                    @foreach($scheduledata as $sch)
                                        ...
                                        <div class="card-row">
                                            <div class="card-row-image" style="width:150px;padding: 20px;height: auto">
                                                {!! SiteHelpers::showUploadedFile(SiteHelpers::gridDisplayView($sch->DoctorID,'UserID','1:tb_users,tb_doctor:DoctorID:avatar',"id = tb_doctor.UserID"),'/uploads/users/',100,'square') !!}
                                            </div>


                                            <div class="card-row-body">

                                                <h4 class="card-row-title"><a href="{{ url('result/doctor/'.$sch->DoctorID) }}">{!! SiteHelpers::gridDisplayView($sch->DoctorID,'DoctorID','1:tb_doctor,tb_users:DoctorID:first_name|last_name',"id = tb_doctor.UserID") !!} </a></h4>
                                                <div class="card-row-content">
                                                    ...
                                                    <div class="speciality">Fee: {!! SiteHelpers::gridDisplayView($sch->DoctorID,'DoctorID','1:tb_doctor:DoctorID:Fee') !!} | <span class="fa fa-thumbs-up"></span> {!! SiteHelpers::gridDisplayView($sch->DoctorID,'DoctorID','1:tb_doctor:DoctorID:Recommendation') !!} </div>
                                                    <div class="accordion-group">
                                                        <div class="accordion-heading">

                                                            @if(SiteHelpers::gridDisplayView($sch->DoctorID,'DoctorID','1:tb_doctor,tb_users:DoctorID:active',"id = tb_doctor.UserID")==1)
                                                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#{{ $sch->DoctorID }}">
                                                                    Book Now
                                                                </a>
                                                            @else
                                                                <span class="text-danger"> Not Currently Available</span>
                                                            @endif
                                                    ...
                                                    <div id="{{ $sch->DoctorID }}" class="accordion-body collapse col-md-12">
