  ...
  <div class="page-content row">
    ...
    <div class="page-header">
      <div class="page-title">
        <h3><i class="fa fa-info"></i> {{CNF_APPNAME}} <sup class="text-danger">powered by EYUVA </sup>  </h3>
      </div>
		   ...
		   <div class="form-group">
				...
				<div class="col-md-8">
					...
					<div style="padding:5px; border:solid 1px #ddd; background:#f5f5f5; width:auto;">
						@if(file_exists(public_path().'/sximo/images/'.CNF_FRONT_LOGO) && CNF_FRONT_LOGO !='')
							<img src="{{ asset('sximo/images/'.CNF_FRONT_LOGO)}}" alt="{{ CNF_APPNAME }}" width="100px" />
						@else
							<img src="{{ asset('sximo/images/logo.svg')}}" alt="{{ CNF_APPNAME }}" />
						@endif
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					...
					<p> <i>Please use image dimension 155px * 30px </i> </p>
					<div style="padding:5px; border:solid 1px #ddd; background:#f5f5f5; width:auto;">
						@if(file_exists(public_path().'/sximo/images/'.CNF_FAVICON) && CNF_FAVICON !='')
							<img src="{{ asset('sximo/images/'.CNF_FAVICON)}}" alt="{{ CNF_APPNAME }}" width="100px" />
						@else
							<img src="{{ asset('sximo/images/logo.png')}}" alt="{{ CNF_APPNAME }}" />
						@endif
					</div>
